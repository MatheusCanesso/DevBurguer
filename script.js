...
// Adiciona o produto e preço quando clica no + de carrinho
...
function addToCart(name, price) {
    // Se o item já existe no carrinho, ele aumenta + 1
...
//Função que vai encontrar o item no carrinho e remover/diminuir sua qtd.
...
checkoutBtn.addEventListener("click", function(){
    ...
    if(!isOpen){
        ...
        Toastify({
            text: "O Resturante está fechado no momento!",
            duration: 3000,
            newWindow: true,
            close: true,
